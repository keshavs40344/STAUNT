...
DESKTOP_DIR = os.path.join(WINDOWS_DIR, "desktop")
...
PERF_JSON = os.path.join(TESTS_DIR, "phase5_7_perf_results.json")
STRESS_JSON = os.path.join(TESTS_DIR, "phase5_7_stress_results.json")
ANDROID_MAIN = os.path.join(STAUNT_ROOT, "android", "app", "src", "main", "kotlin", "com", "staunt", "browser", "MainActivity.kt")
