...
sys.path.insert(0, STAUNT_ROOT)

class TestBrowserPhase5_6(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.desktop_dir = os.path.join(WINDOWS_DIR, "desktop")
        ...
        cls.android_main_path = os.path.join(STAUNT_ROOT, "android", "app", "src", "main", "kotlin", "com", "staunt", "browser", "MainActivity.kt")
        cls.android_newtab_path = os.path.join(STAUNT_ROOT, "android", "app", "src", "main", "assets", "newtab.html")
